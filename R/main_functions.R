...
#' This function plots the outline of the selected cell type. A data.table
#' containing all the graphical information to draw the chosen cell type must be
#' specified through the coords_dt parameter. The data.tables to create various
#' cell types are provided within the package and the plots can be generated by
#' chosen the desired data structure (either cell_dt or neuron_dt). A ggplot
#' object with default colors for the specified cell is then given as output.
#'
#' @description This function creates the plot of the specified cellular
#'   structure.
...
#'
#' @description This function creates a table with ranges for mapping fold
...
#' @return A list of \code{data.table}s (one for each classes specified in the
#'   parameter classes) with categorical classes into which the fold change
#'   values grouped for each subcellular localization are mapped.
#'
#' @import data.table
#'
